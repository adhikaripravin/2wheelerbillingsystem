...
$num = $_GET['num'];
$query = "SELECT * FROM subscriber WHERE num = '$num'";
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Update Subscribers Email</title>
...
<body>
    ...
    <div class="content1">
    <h1> Update Subscribers Email </h1>
    </div>
    <?php
    require "../connection/connection.php";
    ?>
    <div class="container">
  <form action="../auth/updatesubscriber1.php" method="POST">
  <div class="row">
      <div class="col-25">
      </div>
      <div class="col-75">
        <input type="text" value="<?php echo $row['num']?>" name="num">
      </div>
    <div class="row">
      <div class="col-25">
      </div>
